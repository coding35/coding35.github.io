...
import { Fsm2Component } from './fsm2/fsm2.component';

const routes: Routes = [
  { path: 'sm2', component: Sm2Component, data: { page: 'SM2' } },
  { path: 'fsm2', component: Fsm2Component, data: { page: 'FSM2' } },
  ...
  { path: 'reference/:id', component: PageComponent, data: { page: 'reference' } },
  { path: 'reference', component: ContentListComponent, data: { page: 'reference' } },
